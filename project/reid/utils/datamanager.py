...
from utils import mkdir_if_missing, write_json, get_info_from_json
...
class CUHK03(object):
    ...
    def __init__(self, root='data', split_id=0, cuhk03_labeled=False, cuhk03_classic_split=False, **kwargs):
        ...
        self.split_new_det_mat_path = os.path.join(self.dataset_dir, 'CUHK03', 'cuhk03_new_protocol_config_detected.mat')
        self.split_new_lab_mat_path = os.path.join(self.dataset_dir, 'CUHK03', 'cuhk03_new_protocol_config_labeled.mat')
        ...
        splits = get_info_from_json(split_path)
...
if __name__ == "__main__":
    market1501 = Market1501(root=r"E:\files\programming\dataset\reid")
    # cuhk03 = CUHK03(root=r"E:\files\programming\dataset\reid")
